...
const PricingCard = ({ active }: { active: string }) => {
  ...
  return (
    ...
    style={{ borderRadius: '50px' }}">
      {/* free plan */}
      <div className="md:w-[400px] bg-white rounded p-5 my-5 md:my-0 " style={{ borderRadius: '50px' }}>
        <svg
    ...
    {freePlan.map((i: PlanType, index: number) => (
      ...
      <div className="md:w-[400px] bg-white rounded p-5 my-5 md:my-0" style={{ borderRadius: '50px' }}>
        ...
        <h5 className="font-clashDisplay uppercase text-cyber-ink text-3xl pb-8 border-b border-[#000] text-center">
          GROW
        </h5>
        <br />
